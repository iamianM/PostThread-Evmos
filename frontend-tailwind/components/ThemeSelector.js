            ...
            <div title="Change Theme" className="dropdown dropdown-end ">
                ...
                <div className="dropdown-content bg-base-200 text-base-content rounded-t-box rounded-b-box top-px max-h-96 h-[70vh] w-52 overflow-y-auto shadow-2xl mt-16">
                    <div className="grid grid-cols-1 gap-3 p-3" tabIndex="0">
                        <div className="outline-base-content overflow-hidden rounded-lg outline outline-2 outline-offset-2" data-set-theme="light" data-act-classname="outline">
                        ...
                        <div className="outline-base-content overflow-hidden rounded-lg outline outline-2 outline-offset-2" data-set-theme="dark" data-act-classname="outline">
                        ...
                        <div className="outline-base-content overflow-hidden rounded-lg outline outline-2 outline-offset-2" data-set-theme="corporate" data-act-classname="outline">
                        ...
                        <div className="outline-base-content overflow-hidden rounded-lg outline outline-2 outline-offset-2" data-set-theme="synthwave" data-act-classname="outline">
                        ...
                        <div className="outline-base-content overflow-hidden rounded-lg outline outline-2 outline-offset-2" data-set-theme="cyberpunk" data-act-classname="outline">
                        ...
                        <div className="outline-base-content overflow-hidden rounded-lg outline outline-2 outline-offset-2" data-set-theme="valentine" data-act-classname="outline">
                        ...
                        <div className="outline-base-content overflow-hidden rounded-lg outline outline-2 outline-offset-2" data-set-theme="halloween" data-act-classname="outline">
                        ...
                        <div className="outline-base-content overflow-hidden rounded-lg outline outline-2 outline-offset-2" data-set-theme="garden" data-act-classname="outline">
                        ...
                        <div className="outline-base-content overflow-hidden rounded-lg outline outline-2 outline-offset-2" data-set-theme="pastel" data-act-classname="outline">
                        ...
                        <div className="outline-base-content overflow-hidden rounded-lg outline outline-2 outline-offset-2" data-set-theme="fantasy" data-act-classname="outline">
                        ...
                        <div className="outline-base-content overflow-hidden rounded-lg outline outline-2 outline-offset-2" data-set-theme="luxury" data-act-classname="outline">
                        ...
                        <div className="outline-base-content overflow-hidden rounded-lg outline outline-2 outline-offset-2" data-set-theme="dracula" data-act-classname="outline">
                        ...
                        <div className="outline-base-content overflow-hidden rounded-lg outline outline-2 outline-offset-2" data-set-theme="cmyk" data-act-classname="outline">
                        ...
                        <div className="outline-base-content overflow-hidden rounded-lg outline outline-2 outline-offset-2" data-set-theme="autumn" data-act-classname="outline">
                        ...
                        <div className="outline-base-content overflow-hidden rounded-lg outline outline-2 outline-offset-2" data-set-theme="business" data-act-classname="outline">
                        ...
                        <div className="outline-base-content overflow-hidden rounded-lg outline outline-2 outline-offset-2" data-set-theme="acid" data-act-classname="outline">
                        ...
                        <div className="outline-base-content overflow-hidden rounded-lg outline outline-2 outline-offset-2" data-set-theme="lemonade" data-act-classname="outline">
                        ...
                        <div className="outline-base-content overflow-hidden rounded-lg outline outline-2 outline-offset-2" data-set-theme="night" data-act-classname="outline">
